...
<section class="py-5 bg-light">
    <div class="container">
        <h2 class="text-center mb-5">✨ Makeup Products ✨</h2>
...
<script>
    const skincareProducts = [
        { id: 101, name: 'Matte Liquid Lipstick', desc: 'Long-lasting, smudge-proof lipstick available in trendy shades.', price: 19.99, img: '/img/liquidlip.jpeg' },
        { id: 102, name: 'Waterproof Mascara', desc: 'Defines and lengthens lashes with a waterproof, clump-free formula.', price: 12.50, img: '/img/mascara.jpeg' },
        { id: 103, name: 'Natural Glow Foundation', desc: 'A lightweight foundation that blends seamlessly for a natural radiant finish.', price: 24.99, img: '/img/foundation.jpeg' },
        { id: 104, name: 'Eye Shadow', desc: 'Highly-pigmented, buildable color and long lasting products', price: 15.00, img: '/img/eyeshadow.jpeg' }
    ];
