...
<script>
    const skincareProducts = [
        { id: 101, name: 'Floral Bliss Eau de Parfum', desc: 'A fresh blend of jasmine, rose, and lily for an elegant floral scent.', price: 19.99, img: '/img/floral.jpeg' },
        { id: 102, name: 'Woody Musk Perfume', desc: 'Earthy sandalwood and musk tones for a bold, long-lasting fragrance.', price: 12.50, img: '/img/woody.jpeg' },
        { id: 103, name: 'Citrus Fresh Cologne', desc: 'Refreshing citrus blend of lemon and bergamot for daily wear.', price: 24.99, img: '/img/citus.jpeg' },
        { id: 104, name: 'Eau de Cologne by Mäurer & Wirtz', desc: ' clean, crisp fragrance captures the best moments in life Brings you the warmth, freshness & energy. ', price: 15.00, img: '/img/eau.jpeg' }
    ];
